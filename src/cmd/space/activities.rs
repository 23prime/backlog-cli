...
mod tests {
    ...
    fn activities_with_text_output_succeeds() {
        ...
        assert!(
            activities_with(
                &SpaceActivitiesArgs::try_new(false, vec![], None, None, 20, None).unwrap(),
                &api
            )
            .is_ok()
        );
    ...
    fn activities_with_json_output_succeeds() {
        ...
        assert!(
            activities_with(
                &SpaceActivitiesArgs::try_new(true, vec![], None, None, 20, None).unwrap(),
                &api
            )
            .is_ok()
        );
    ...
    fn try_new_rejects_min_id_greater_than_max_id() {
        assert!(SpaceActivitiesArgs::try_new(false, vec![], Some(20), Some(10), 20, None).is_err());
    }
    ...
    fn activities_with_builds_correct_query_params() {
        ...
        let args = SpaceActivitiesArgs::try_new(
            false,
            vec![1, 2],
            Some(10),
            Some(20),
